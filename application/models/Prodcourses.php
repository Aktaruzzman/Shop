...
class Prodcourses extends MY_Model
{

    function __construct()
    {
        parent::__construct();
        $this->_table_name = 'prodcourses';
    ...
    {
        $is_name_en_unique = $this->check_unique('name_en', $this->input->post('name_en')) ? "|is_unique[prodcourses.name_en]" : "";
        $is_name_bn_unique = $this->check_unique('name_bn', $this->input->post('name_bn')) ? "|is_unique[prodcourses.name_bn]" : "";
