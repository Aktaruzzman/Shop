...
class Incomesectors extends MY_Model
{

    function __construct()
    {
        parent::__construct();
        $this->_table_name = 'incomesectors';
    ...
    {
        $is_name_en_unique = $this->check_unique('name_en', $this->input->post('name_en'), ['hub_id' => $this->input->post('hub_id')]) ? "|is_unique[incomesectors.name_en]" : "";
        $is_name_bn_unique = $this->check_unique('name_bn', $this->input->post('name_bn'), ['hub_id' => $this->input->post('hub_id')]) ? "|is_unique[incomesectors.name_bn]" : "";
