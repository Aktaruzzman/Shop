...
class Prodbybarcode extends REST_Controller
{
    ...
    public function index_get($barcode = null, $supplier = null)
    {
        if (!empty($barcode)) {
            $code = $this->Prodcodes->get_by(['barcode' => $barcode], true, false, ['item_id', 'option_id']);
            if (!empty($code)) {
