...
class Bar extends REST_Controller
{
    ...
    public function index_get($id = NULL)
    {
        ...
        $results['bar'] = $this->Cfgservices->get_by(['value' => 'bar'], TRUE, TRUE, NULL, NULL, NULL, ['value', 'delay', 'charge']);
    ...
    public function index_post()
    {
        ...
        $delivery_time_arr = delivery_time('bar', '', '');
        ...
        $customer = !empty($entity['phone']) ? $this->Customers->get(['phone' => $entity['phone']], TRUE, TRUE) : NULL;
        if (!empty($customer))
