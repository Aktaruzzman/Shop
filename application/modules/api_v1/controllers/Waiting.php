...
class Waiting extends REST_Controller
{
    ...
    public function index_get($id = NULL)
    {
        ...
        $results['waiting'] = $this->Cfgservices->get_by(['value' => 'waiting'], TRUE, TRUE, NULL, NULL, NULL, ['value', 'delay', 'charge']);
        $results['guest'] = $this->Guestnumbers->get_max('id') + 1;
    ...
    public function index_post()
    {
        ...
        $this->Guestnumbers->save(['sale_id' =>  $results['order']->id]);
